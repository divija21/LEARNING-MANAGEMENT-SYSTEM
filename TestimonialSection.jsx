...
import { assets, dummyTestimonial } from '../../assets/assets'
  ...
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Here from our learners as they share their journeys of transformation ,succes ,and how our <br/> 
...
<div className='flex items-center gap-4 px-5 py-4 bg-gray-500/10'>
  ...
  <div>
    <h1 className='text-lg font-meduium text-gray-800'>{testimonial.name}</h1>
